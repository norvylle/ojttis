...
class Admin extends Component{
	render(){
		return(
			...
			<Dropdown.Item><a href={"/student-delete"}><Button content='Delete Student' icon="delete" labelPosition='left' size="big" fluid/></a></Dropdown.Item>
			...
			<Dropdown.Item><a href={"/ojt-delete"}><Button content='Delete Company' icon="delete" labelPosition='left' size="big" fluid/></a></Dropdown.Item>
			...
			<Dropdown.Menu inverted>
			<Dropdown.Item><a href={"/intern-add"}><Button content='Add Intern' icon="add" labelPosition='left' size="big" fluid/></a></Dropdown.Item>
			<Dropdown.Item><a href={"/intern-delete"}><Button content='Delete Intern' icon="delete" labelPosition='left' size="big" fluid/></a></Dropdown.Item>
			...
			<br/><br/>
			<a href={"/constant-update"}><Button content='Constants' icon="edit" labelPosition='left' size="big"/></a>
			<br/><br/>
